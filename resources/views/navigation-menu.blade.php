        ...
        <div class="flex justify-between h-auto">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 hidden sm:flex sm:items-center">
                    <a href="{{ route('mobile.home') }}" aria-label="{{ __('ui.layout.open_mobile') }}" class="inline-flex items-center p-2 rounded-md hover:bg-gray-100 text-gray-600">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M7 2a1 1 0 00-1 1v12a1 1 0 001 1h6a1 1 0 001-1V3a1 1 0 00-1-1H7z"></path><path d="M3 6h14v2H3V6z" fill-opacity="0.6"></path></svg>
                    </a>
                </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center justify-between px-4">
                <div class="flex items-center">
                    ...
                    @endif
                    <div>
                        <div class="font-medium text-base text-gray-800">{{ Auth::user()->name }} {{ Auth::user()->family_name1 }}</div>
