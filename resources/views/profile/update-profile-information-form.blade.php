            ...
            <div x-data="{ photoName: null, photoPreview: null }" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}"
                        alt="{{ $this->user->name }} {{ $this->user->family_name1 }}"
            ...
            <div class="relative">
                ...
                <button type="button" @click="showUserCode = !showUserCode"
                    ...
                    <svg x-show="showUserCode" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.96 9.96 0 012.292-3.938m0 0A9.96 9.96 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21m-5.6-5.6l-2.8-2.8m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                    </svg>
                </button>
            </div>
