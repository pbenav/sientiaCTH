<div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-4">
                                    @if (Gate::check('addTeamMember', $team))
                                        ...
                                        <form method="POST"
                                            action="{{ route('teams.invitations.accept', [$team, $invitation]) }}"
                                            class="inline">
                                            @csrf
                                            <button type="submit"
                                                class="text-sm text-green-600 hover:text-green-900 focus:outline-none">
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="content">
                    <div class="space-y-6">
                        @foreach ($team->users->sortBy(function ($u) {
        return strtolower($u->full_name);
    }) as $user)
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @php
                                        ...
                                        if ($user->membership?->custom_role_id) {
                                            ...
                                            $customRolesCache[$roleId] =
                                                $customRolesCache[$roleId] ?? \App\Models\Role::find($roleId);
    ...
    <x-jet-dialog-modal wire:model="currentlyManagingRole">
        ...
        <x-slot name="footer">
            ...
            <x-jet-button class="ml-3 bg-indigo-600 hover:bg-indigo-700" wire:click="updateRole"
