<div wire:poll.5s="refreshCount">
    <a href="{{ route('messages') }}" class="relative inline-flex items-center p-2 rounded-md hover:bg-blue-100 hover:text-blue-600 text-gray-600 transition-colors duration-200">
