<div class="flex flex-col m-5 sm:m-10 w-">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg h-36 flex flex-col justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-400">Horas registradas vs programadas</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg h-36 flex flex-col justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-800">{{ $scheduledHoursFmt }}</p>
                                <p class="text-xs text-gray-400">Horas según horario laboral</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg h-36 flex flex-col justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-800">{{ $totalHoursFmt }}</p>
                                <p class="text-xs text-gray-400">Horas realmente trabajadas</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg h-36 flex flex-col justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-400">Fichajes fuera de horario</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg h-36 flex flex-col justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-400">Eventos cerrados automáticamente</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div x-data="{ showModal: false, events: [] }" x-on:open-events-modal.window="events = $event.detail.events; showModal = true"
        ...
        <div x-show="showModal" class="bg-white rounded-lg shadow-xl transform sm:w-full sm:max-w-2xl">
                            ...
                            <template x-for="event in events" :key="event.id">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"
                                        x-text="event.event_type ? event.event_type.name : 'N/A'"></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                        x-text="event.description"></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                        x-text="new Date(event.start).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})">
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                        x-text="new Date(event.end).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})">
                                    </td>
                                </tr>
                            </template>
