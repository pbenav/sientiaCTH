<div>
    <!-- Event Info Modal Simple -->
    @if($showModal && $eventData)
        <x-jet-dialog-modal wire:model="showModal" maxWidth="4xl">
            <x-slot name="title">
            ...
            <x-slot name="content">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">{{ __('Basic Info') }}</h4>
                    ...
                    <div class="space-y-4 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                        <h4 class="text-xs font-bold text-indigo-500 uppercase tracking-wider mb-3">{{ __('Timing') }}</h4>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div class="pt-2 border-t border-gray-100">
                                ...
                                <p class="text-lg font-bold text-indigo-600 mt-1">
                                    ...
                                    @else
                                        <span class="text-gray-400 text-sm">{{ __('N/A') }}</span>
                                    @endif
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">{{ __('Status & Meta') }}</h4>
